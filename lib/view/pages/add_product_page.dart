...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  final List<DropdownMenuItem<String>> fetchedTypes = [];
  List<dynamic> types = [];
  ...
  Future<bool> fetchTypes() async {
    ...
    try {
      final results = jsonDecode(
        await http.get(route: 'productType/all').then((value) => value.body),
      )['types'];
  ...
  Future<void> saveProduct() async {
    if (formKey.currentState!.validate()) {
      ...
      try {
        ...
        showErrorDialog(context, "Error saving product. Try again");
      }
    }
  }
}
